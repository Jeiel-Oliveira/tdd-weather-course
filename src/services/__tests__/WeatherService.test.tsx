...
import { nullCurrentWeatherRawResponse, CurrentWeatherRawResponseDto } from '../dto/weather-service.dto'
...
describe('WeatherService', () => {
  ...
  test('Should return formatted CurrentWeather with empty weather', async () => {
